...
import { GetDashborardDTO, GetFinancialEvolutionDTO, IndexTransactionsDTO } from "../../dtos/transactions.dto"
...
export class TransactionsRepository{
    ...
    async getBalance ({beginDate, endDate}: GetDashborardDTO):Promise<Balance> {
    ...
    async getExpenses({beginDate, endDate}: GetDashborardDTO): Promise<Expense[]>{
